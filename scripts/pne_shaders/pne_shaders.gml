...
global.u_shadowmap_enable_vertex = new Uniform("u_shadowmap_enable_vertex", UniformTypes.INTEGER)
global.u_shadowmap_enable_pixel = new Uniform("u_shadowmap_enable_pixel", UniformTypes.INTEGER)
global.u_shadowmap_view = new Uniform("u_shadowmap_view", UniformTypes.MATRIX)
global.u_shadowmap_projection = new Uniform("u_shadowmap_projection", UniformTypes.MATRIX)
global.u_shadowmap = new Uniform("u_shadowmap", UniformTypes.TEXTURE)
global.u_shadowmap_caster = new Uniform("u_shadowmap_caster", UniformTypes.INTEGER)
