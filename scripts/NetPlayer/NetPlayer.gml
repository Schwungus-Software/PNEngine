function NetPlayer() constructor {
	...
	static reliable_callback = function (_self) {
		with _self {
	...
	reliable_time_source = time_source_create(time_source_global, 0.25, time_source_units_seconds, reliable_callback, [self], -1)
